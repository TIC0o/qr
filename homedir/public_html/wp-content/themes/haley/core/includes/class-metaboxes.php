...
if( !class_exists( 'haley_metaboxes' ) ) {

	class haley_metaboxes {
		...
		public function __construct( $posttype, $fields = array() ) {
			...
			add_action( 'save_post', array( &$this, 'haley_metaboxes_save' ) );
		}
		...
		public function metaboxes_panel() {
			...
			case 'navigation': ?>
				...
				<div id="tabs" class="haley_metaboxes">
				...
				switch ( $field['type'] ) { 
					...
					<div class="haley_inputbox">
						...
						<div class="input-right">
							...
							<input name="<?php echo esc_attr($field['id']); ?>" id="<?php echo esc_attr($field['id']); ?>" type="<?php echo esc_attr($field['type']); ?>" value="<?php if ( haley_postmeta( $field['id']) != "") { echo esc_attr(haley_postmeta( $field['id'])); } ?>" />
					...
					<div class="haley_inputbox">
						...
						<div class="input-right">
							...
							<select name="<?php echo esc_attr($field['id']); ?>" id="<?php echo esc_attr($field['id']); ?>" >
								...
								<option <?php if ( haley_postmeta($field['id']) == $option || ( !haley_postmeta($field['id']) && $field['std'] == $option )) { echo 'selected="selected"'; } ?> value="<?php echo esc_attr($option); ?>"><?php echo esc_html($values); ?></option><?php } ?>  
					...
					<div class="haley_inputbox">
                        ...
                        <div class="input-right">
                            ...
                            <textarea name="<?php echo esc_attr($field['id']); ?>" id="<?php echo esc_attr($field['id']); ?>" type="<?php echo esc_attr($field['type']); ?>" ><?php if ( haley_postmeta( $field['id']) != "") { echo stripslashes(haley_postmeta( $field['id'])); } ?></textarea>
		...
		public function haley_metaboxes_save() {
